...
var DashboardQueries = /** @class */ (function () {
    ...
    DashboardQueries.prototype.fetchProduct = function (productId, orderStatus) {
    ...
    DashboardQueries.prototype.productsByPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT name, price, orders.id FROM products INNER JOIN orders ON products.id = orders.product_id';
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
