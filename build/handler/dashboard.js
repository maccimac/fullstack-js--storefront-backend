...
var productsByPrice = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.productsByPrice()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
...
var fetchProductOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var resolvedOrderStatus, orders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log(req.params);
                resolvedOrderStatus = req.params.orderStatus ? req.params.orderStatus : 'complete';
                return [4 /*yield*/, dashboard.fetchProduct(req.params.productId, resolvedOrderStatus)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
